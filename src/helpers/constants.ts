...
export const pollutants: Pollutants = {
    ...
    no: {
        code: "no",
        displayName: "NO",
        solution: "To lessen the impact of NO on your health and the environment, opt for energy-efficient transportation options like biking or walking, which produce minimal nitrogen oxide emissions compared to vehicles. Additionally, regularly maintain your vehicle to ensure it operates efficiently and emits fewer pollutants into the air."
    },
    nox: {
        code: "nox",
        displayName: "NOX",
        solution: "To reduce NOX emissions, consider carpooling or using public transportation to decrease vehicle exhaust, a major source of nitrogen oxides. Additionally, maintaining your vehicle regularly can help ensure it operates efficiently and emits fewer pollutants into the air."
    },
    no2: {
        code: "no2",
        displayName: "NO2",
    ...
    so2: {
        code: "so2",
        displayName: "SO2",
        solution: "To reduce SO2 emissions, opt for cleaner energy sources like renewable energy or electric appliances, which emit fewer sulfur dioxide pollutants compared to burning fossil fuels. Additionally, using low-sulfur fuels and employing emission control technologies can help mitigate the impact of SO2 on air quality."
    },
    trs: {
        code: "trs",
        displayName: "TRS",
        solution: "To lessen TRS emissions, avoid products containing sulfur compounds and promote improved waste management practices in industries like pulp and paper manufacturing. These actions can help reduce the release of total reduced sulfur into the atmosphere, improving air quality and minimizing odor issues."
    },
};
