<template>
    <FormDialog
        :formTitle="
            $t(`my-organization.admin-component.user-table-section-container.user-table.actions.delete-user.title`)
        "
        formIcon="mdi-delete-outline"
        :formCancelButton="
            $t(`my-organization.admin-component.user-table-section-container.user-table.actions.delete-user.cancel`)
        "
        :formConfirmButton="
            $t(`my-organization.admin-component.user-table-section-container.user-table.actions.delete-user.confirm`)
        "
        :formClose="closeForm"
    ...
    >
        ...
        <ParagraphContainer
            ...
            :paragraphContent="
                $t(
                    `my-organization.admin-component.user-table-section-container.user-table.actions.delete-user.paragraph-1`
                )
            "
        />
        ...
        <ParagraphContainer
            ...
            :paragraphContent="
                $t(
                    `my-organization.admin-component.user-table-section-container.user-table.actions.delete-user.paragraph-2`
                )
            "
        />
        ...
        <ParagraphContainer
            ...
            :paragraphContent="
                $t(
                    `my-organization.admin-component.user-table-section-container.user-table.actions.delete-user.paragraph-3`
                )
            "
        />
    </FormDialog>
